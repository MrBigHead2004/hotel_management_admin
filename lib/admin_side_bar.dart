    ...
    return Drawer(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            Padding(
              padding: const EdgeInsets.only(top: defaultPadding * 3, bottom: defaultPadding),
              child: Text(
                'Hotel IT3180',
                style: TextStyle(
                  fontSize: 20,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: IconTheme(
          data: IconThemeData(color: getElementColor(isSelected, themeNotifier.isDarkMode)),
          child: icon,
        ),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(defaultCornerRadius)),
        tileColor: isSelected ? (themeNotifier.isDarkMode ? Colors.white.withOpacity(0.2) : Colors.black.withOpacity(0.2)) : Colors.transparent,
        hoverColor: themeNotifier.isDarkMode ? Colors.white.withOpacity(0.1) : Colors.black.withOpacity(0.1),
        title: Text(
          title,
          style: TextStyle(
            fontSize: 16,
