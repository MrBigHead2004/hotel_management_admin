  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: SingleChildScrollView(
        padding: const EdgeInsets.only(top: defaultPadding * 2, left: defaultPadding * 2, right: defaultPadding * 2),
        child: Row(
            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('New Booking', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 20)),
                    const SizedBox(height: defaultPadding * 2),

                    const Text('Customer information', style: TextStyle(fontWeight: FontWeight.w600)),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: themeNotifier.isDarkMode ? darkTertiaryBgColor : Colors.white,
                        borderRadius: BorderRadius.circular(defaultCornerRadius),
                      ),
                      child: Row(
                        children: [
                          Icon(Icons.hotel, color: themeNotifier.isDarkMode ? Colors.white : Colors.black),
                    ...
                    const Text('Date selection', style: TextStyle(fontWeight: FontWeight.w600)),
                    const SizedBox(height: defaultPadding),
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      decoration: InputDecoration(
        ...
        fillColor: themeNotifier.isDarkMode ? darkTertiaryBgColor : Colors.white,
        filled: true,
        prefixIcon: icon,
