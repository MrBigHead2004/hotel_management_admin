      ...
      for (var booking in bookingData) {
        try {
          ...
          bookings.add({
            ...
            'booking_date': (booking['booking_time'] ?? 'N/A').toString().split('.')[0],
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: Container(
            margin: const EdgeInsets.only(left: defaultPadding * 2, right: defaultPadding * 2, top: defaultPadding, bottom: defaultPadding * 2),
